 ...
 */
public class Businesspartner extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.busunesspartner, container, false);
        ...
        terlist.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position != 0) {
                    ...
                    getretailer(Constants.URL+"customerlist=1&type=bp&territory=" + code);
                }
            }
        ...
        retaillist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                getdetailuser(Constants.URL+"customerd=1&type=bp&code=" + code);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status == 0) {
                                ...
                                propname.setText("Email : " + jsonObject.getString("email"));
