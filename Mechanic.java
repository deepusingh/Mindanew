...
public class Mechanic extends Fragment {
    ...
    LinearLayout traderslayout;
    TextView retname, retaddr, retphone,propname;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.mechanic, container, false);
        ...
        addnewret = (Button) rootView.findViewById(R.id.btaddnewmechanic);
...
//                }
        ...
        reatalerordercartbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("Type", "mechanic");
                bundle.putString("name", tname);
                bundle.putString("page", "mechanic");
        ...
        terlist.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position != 0) {
                    ...
                    getretailer(Constants.URL+"customerlist=1&type=mechanic&territory=" + code);
                }
            }
        ...
        retaillist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                getdetailuser(Constants.URL+"customerd=1&type=mechanic&code=" + code);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status == 0) {
                                ...
                                Toast.makeText(getActivity(), "No Mechanic Available", Toast.LENGTH_SHORT).show();
                            } else {

                                JSONArray jsonArray = jsonObject.getJSONArray("territory");

                                teritory.add("Select here");
